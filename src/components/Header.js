...
import jPrime from "./pictures/jumiaPrime_19th.gif";

function Header() {
  return (
    <div id="header">
      <div id='header-prime'>
      <div id='header-jprime'>
        <img src={jPrime} alt="" />
      </div>
      </div>
      <div id="header1">
        ...
        <div id="header-jumia">
          <img src={jumia} alt="tyl" />
        </div>
        <div id="header-logo1">
          <a href="#">
            <img src={food1} alt="tyl" height="50%" />
            FOODS
          </a>
          <a href="#">
            <img src={travel1} alt="tyl" height="50%" />
            TRAVEL
          </a>
          <a href="#">
            <img src={flights} alt="tyl" height="50%" />
            FLIGHT
          </a>
          <a href="#">
            <img src={deal} alt="tyl" height="50%" />
            DEALS
          </a>
          <a href="#">
            <img src={house1} alt="tyl" height="50%" />
            HOUSE
          </a>
          <a href="#">
            <img src={party} alt="tyl" height="50%" />
            PARTY
          </a>
          <a href="#">
            <img src={one} alt="tyl" height="50%" />
            ONE
          </a>
        </div>
      </div>
      <div id="header2">
        <div id="header2i">
          ...
          <div id="need">
            <p>
              Need <br /> <span>Help?</span>{" "}
            </p>
            <p>
              Your <br /> <span>Account</span>{" "}
            </p>
          </div>
        </div>
      </div>
          ...
          <div id="sell">
            <div className="buy" id="buy1">
              ...
              <p>
                {" "}
                SELL ON JUMIA <br />
                <span>Millions of Monthly Visitors</span>{" "}
              </p>
            </div>
            <div className="buy">
              ...
              <p>
                PAY ON DELIVERY <br />
                <span>After Checking the Product</span>{" "}
              </p>
            </div>
            <div className="buy">
